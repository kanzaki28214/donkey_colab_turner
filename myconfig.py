...
TRAIN_TEST_SPLIT = 0.95          #what percent of records to use for training. the remaining used for validation.
...
# # AUGMENTATIONS
AUG_BRIGHTNESS_RANGE = 0.5  # this is interpreted as [-0.2, 0.2]
AUG_BLUR_RANGE = (0, 3)
# 
# # "CROP" Transformation
